...
Describes a character matrix associated with positional information
(time/height) for application of taphonomic and stratigraphic effects.
...
- `pos`: named vector containing positional information (time or height)
  for the taxa
...
Modified by `apply_taphonomy`. For logical reasons,
`apply_niche.char_mat` throws an error.
