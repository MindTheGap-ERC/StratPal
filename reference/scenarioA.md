...
- `dist_from_shore` : character vector. Distance from shore in km of
  locations at which the observations were made. Available distances are
  "2km", "4km", "6km", "8km", "10km", "12km".

- `h_m` : matrix of size length(t_myr) x length(dist_from_shore).
  Accumulated sediment height in m at examined locations
...
- Burgess, Peter. 2013. "CarboCAT: A cellular automata model of
  ...
  [doi:10.1016/j.cageo.2011.08.026](https://doi.org/10.1016/j.cageo.2011.08.026)
  .

- Burgess, Peter. 2023. "CarboCATLite v1.0.1." Zenodo.
  [doi:10.5281/zenodo.8402578](https://doi.org/10.5281/zenodo.8402578)
...
- Hohmann, Niklas; Koelewijn, Joël R.; Burgess, Peter; Jarochowska,
  ...
  [doi:10.1186/s12862-024-02287-2](https://doi.org/10.1186/s12862-024-02287-2)
  .
...
- Hohmann, Niklas, Koelewijn, Joël R.; Burgess, Peter; Jarochowska,
  ...
  [doi:10.17605/OSF.IO/ZBPWA](https://doi.org/10.17605/OSF.IO/ZBPWA) ,
  published under the [CC-BY
