...
Here we describe the modeling pipeline for the stratigraphic paleobiology of phenotypic evolution. For details how this can be combined with the `paleoTS` package, see
...
For details on how the `StratPal` package can be integrated with the `paleoTS` package, see
