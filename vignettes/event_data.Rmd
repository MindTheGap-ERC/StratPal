...
Throughout this examples, we use the age-depth models from 2 km and 12 km offshore in the example data that emulates scenario A from [Hohmann et al. (2024)](#References). See `?scenarioA` and `vignette("StratPal")` for details on scenario A.
