...
This vignette explain how to link the `StratPal` package with the `paleoTS` package. For details on the underlying data structures, see `vignette("StratPal_docs")`.
...
```{r}
library(StratPal)
library(paleoTS)   # needed for plotting and conversion
