...
In the `StratPal` package and its vignettes, we make heavy use of the base R *pipe* operator `|>`. While this is not required to run the package, it simplifies the code and makes the underlying logic of a modeling *pipeline* clearer.
