...
FossilSim:::plot.fossils(f, tree = tree, taxonomy = s, show.taxonomy = TRUE)
```
...
FossilSim:::plot.fossils(f_niche, tree, taxonomy = s, show.taxonomy = TRUE)
```
...
FossilSim:::plot.fossils(f_strat, tree = tree_strat, taxonomy = s_strat, show.taxonomy = TRUE)
```
